<p align="center">
  <img src="docs/banner.svg" alt="Говорун для macOS — оффлайн-голосовой ввод на русском" width="100%">
</p>
...
[Silero VAD](https://github.com/snakers4/silero-vad) нарезает речь на фрагменты по паузам, а GigaAM распознаёт их локально. После остановки записи Говорун собирает готовый текст и вставляет его в активное приложение.
...
- **Защита от зависания интерфейса.** В Говоруне есть сторож главного потока: если UI зависнет дольше ~30 секунд, приложение само завершится, чтобы не греть процессор и не сажать батарею. После этого просто запустите приложение заново.
